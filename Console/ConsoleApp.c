...
#line 10 "ConsoleApp.pgc"
 char search [ 20000 ] , query [ 20000 ] , x [ 20000 ] , username [ 200 ] , name [ 100 ] ;
...
int main()
{
	...
	strcpy(name,"201501188@10.100.71.21");
    { ECPGconnect(__LINE__, 0, name , username , NULL , NULL, 0); 
#line 120 "ConsoleApp.pgc"
